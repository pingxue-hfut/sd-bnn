...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for i in range(3):
            ...
            model.module.layer1[i].conv1.k.data = k
            model.module.layer1[i].conv2.k.data = k
            model.module.layer1[i].conv1.t.data = t
            model.module.layer1[i].conv2.t.data = t

            model.module.layer2[i].conv1.k.data = k
            model.module.layer2[i].conv2.k.data = k
            model.module.layer2[i].conv1.t.data = t
            model.module.layer2[i].conv2.t.data = t

            model.module.layer3[i].conv1.k.data = k
            model.module.layer3[i].conv2.k.data = k
            model.module.layer3[i].conv1.t.data = t
            model.module.layer3[i].conv2.t.data = t
